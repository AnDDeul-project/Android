...
import com.umc.anddeul.databinding.FragmentMypageTermsBinding

class MyPageTermsFragment: Fragment() {
    lateinit var binding : FragmentMypageTermsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMypageTermsBinding.inflate(inflater, container, false)
    ...
    private fun settingToolbar() {
        binding.mypageTermsBackIv.setOnClickListener {
            val fragmentManager = requireActivity().supportFragmentManager
            fragmentManager.popBackStack()
        }
    }

    private fun settingTerms() {
        val termText1 = """
            제1장 총칙
...
③ 운영정책을 개정하는 경우에는 제4조 제2항의 절차에 따릅니다. 다만, 운영정책 개정내용이 다음 각 호의 어느 하나에 해당하는 경우에는 제2항의 방법으로 사전에 공지합니다. 
 ...
 ⑦ 이 조는 회사가 서비스를 운영하는 동안 유효하며, 회원 탈퇴 후에도 지속적으로 적용됩니다.
        ...
        binding.mypageTermsTermsText1.text = termText1
...
④ 회사는 회원의 귀책사유로 개인정보가 유출되어 발생한 피해에 대하여 책임을 지지 않습니다.
        ...
        binding.mypageTermsTermsText2.text = termText2
...
회사는 다음 각 호의 행위의 구체적인 내용을 정할 수 있으며, 회원은 이를 따라야 합니다.
  ...
  4. 카카오, 페이스북, 구글플러스 등 외부 모바일 플랫폼 제휴 서비스 정책
        ...
        binding.mypageTermsTermsText3.text = termText3

        // 첫 번째 약관
        binding.mypageTermsTerms1.setOnClickListener {
            if (!termsOpen1) {
                termsOpen1 = true
                binding.mypageTermsTermChild1.visibility = View.VISIBLE
                binding.mypageTermsTermMore1.visibility = View.GONE
                binding.mypageTermsTermClose1.visibility = View.VISIBLE
                termsOpenedCnt += 1
            }
            else{
                termsOpen1 = false
                binding.mypageTermsTermChild1.visibility = View.GONE
                binding.mypageTermsTermMore1.visibility = View.VISIBLE
                binding.mypageTermsTermClose1.visibility = View.GONE
                termsOpenedCnt -= 1
            }
        }

        // 두 번째 약관
        binding.mypageTermsTerms2.setOnClickListener {
            if (!termsOpen2) {
                termsOpen2 = true
                binding.mypageTermsTermChild2.visibility = View.VISIBLE
                binding.mypageTermsTermMore2.visibility = View.GONE
                binding.mypageTermsTermClose2.visibility = View.VISIBLE
                termsOpenedCnt += 1
            }
            else{
                termsOpen2 = false
                binding.mypageTermsTermChild2.visibility = View.GONE
                binding.mypageTermsTermMore2.visibility = View.VISIBLE
                binding.mypageTermsTermClose2.visibility = View.GONE
                termsOpenedCnt -= 1
            }
        }

        // 세 번째 약관
        binding.mypageTermsTerms3.setOnClickListener {
            if (!termsOpen3) {
                termsOpen3 = true
                binding.mypageTermsTermChild3.visibility = View.VISIBLE
                binding.mypageTermsTermMore3.visibility = View.GONE
                binding.mypageTermsTermClose3.visibility = View.VISIBLE
                termsOpenedCnt += 1
            }
            else{
                termsOpen3 = false
                binding.mypageTermsTermChild3.visibility = View.GONE
                binding.mypageTermsTermMore3.visibility = View.VISIBLE
                binding.mypageTermsTermClose3.visibility = View.GONE
                termsOpenedCnt -= 1
            }
        }
    }
